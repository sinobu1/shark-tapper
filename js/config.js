...
export const config = {
  ...
  helpers: {
    dolphin: {
      ...
      rarity: "common",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/patapim.png?raw=true",
    },
    orca: {
  ...
  skins: {
    basic: {
      ...
      rarity: "common",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark.png?raw=true",
    ...
    gold: {
      ...
      rarity: "rare",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark_whoterstorm.png?raw=true",
    ...
    robot: {
      ...
      rarity: "rare",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark_sakura.png?raw=true",
      description: (mult) => `x${mult} к силе тапа`,
    },
    dragon: {
      name: "Акула-дракон",
      ...
      rarity: "epic",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark_darkside.png?raw=true",
      description: (mult) => `x${mult} к силе тапа`,
    },
    cyber: {
      name: "Кибер-акула",
      ...
      rarity: "epic",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark_qr.png?raw=true",
      description: (mult) => `x${mult} к силе тапа`,
    },
    legendary: {
      ...
      rarity: "legendary",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/shark_storm.png?raw=true",
      description: (mult) => `x${mult} к силе тапа`,
    },
  },
  lootboxes: {
    common: {
      ...
      currency: "coin",
      imageUrl:
        "https://github.com/sinobu1/shark-tapper/blob/main/sunduk.png?raw=true",
      rarity: "common",
