...
const GameState = (() => {
    ...
    let state = {
        ...
        helpers: [
          { id: 'dolphin', name: 'NFT Дельфин', cost: 500, income: 20, owned: 0, currency: 'coins', costIncrease: 1.15, rarity: 'common' },
        ...
        upgrades: [
          ...
          { id: 'criticalChance', name: 'NFT Критический шанс', cost: 5000, effect: 0.01, owned: 0, currency: 'coins', maxLevel: 5, rarity: 'rare', costIncrease: 2 }, // Эффект 0.01 = +1%
          { id: 'oreChance', name: 'NFT Удача рудокопа', cost: 3000, effect: 0.005, owned: 0, currency: 'coins', maxLevel: 10, rarity: 'rare', costIncrease: 1.8 }, // Эффект 0.005 = +0.5%
          { id: 'energyRegen', name: 'NFT Регенерация', cost: 10, effect: 1, owned: 0, currency: 'gems', maxLevel: 5, rarity: 'epic', costIncrease: 2.5 },
          { id: 'energyMax', name: 'NFT Энергия+', cost: 5, effect: 50, owned: 0, currency: 'gems', maxLevel: 10, rarity: 'epic', costIncrease: 1.5 },
          { id: 'incomeMultiplier', name: 'NFT Множитель дохода', cost: 10000, effect: 1.2, owned: 0, currency: 'coins', maxLevel: 5, rarity: 'legendary', costIncrease: 3 } // Множитель, не добавка
        ],
        skins: [
           ...
           { id: 'legendary', name: 'NFT Легендарная акула', cost: 100000, costGems: 0, costOre: 0, /*costStars: 5,*/ multiplier: 10, owned: false, rarity: 'legendary' } // costStars УДАЛЕНО
        ],
        currentSkin: 'basic',
        unlockedSkins: ['basic'],
        lootboxes: {
