...
function feedback() {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const SHARK_SKIN2_URL = "https://sinobu1.github.io/shark-tapper/";
            const SHARK_SKIN3_URL = "https://sinobu1.github.io/shark-tapper/";
    ...
    if (tapImage) tapImage.src = getSkinUrl(userData.skin);
...
function init() {
  console.log("INIT: inside function");
  const tapImage = document.getElementById("tapImage");
  console.log("tapImage:", tapImage);
                setupEventListeners();
                loadTelegram();
                initLocalStorage();
                updateDisplay();
...
function fakeVibrationIOS() {
  const shark = document.getElementById("tapImage");
  if (shark) {
    shark.classList.add("vibrate-ios");
    setTimeout(() => shark.classList.remove("vibrate-ios"), 150);
  }
}
